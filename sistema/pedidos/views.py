    ...
    if request.method == 'POST':
        ...
        if cliente_id and produto_id and kg:
            try:
                ...
                pedido.save()  # save() calcula o valor automaticamente via model
                ...
                messages.error(request, 'Quantidade (kg) inválida.')
        else:
...
def alterar_status(request, pk):
    """Alterna o status do pedido: Pendente → Entregue → Pendente."""
    pedido = get_object_or_404(Pedido, pk=pk)
